...
// Меню
(function(){
	var menu = $('.lay-header .main-menu');
	var menuOpener =  $('.lay-header .menu-button');
	...
	$('ul.lvl-2', menu).each(function(){
		var expander = $('<a class="expander icon-angle-right" href="javascript:;"></a>');
		var subMenu = $(this);
		subMenu.before(expander);
		expander.click(function(){
			if(expander.hasClass('expanded')){
				expander.removeClass('expanded');
				subMenu.slideUp();
			} else {
				$('.expanded', menu).removeClass('expanded');
				$('ul.lvl-2', menu).slideUp();
